...
public class Booking {
    ...
    public Booking(final String bookingNumber, final LocalDate start, final LocalDate end, final Customer customer, final boolean canceled, final String carModel) {
    ...
    public String toString() {
        return "Booking{" + "bookingNumber=" + bookingNumber + ", start=" + start + ", end=" + end + ", customer=" + customer + ", cancelled=" + canceled + ", carModel=" + carModel + '}';
    }
